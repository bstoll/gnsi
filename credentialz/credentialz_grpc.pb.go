...
func (c *credentialzClient) RotateAccountCredentials(ctx context.Context, opts ...grpc.CallOption) (Credentialz_RotateAccountCredentialsClient, error) {
	...
	x := &credentialzRotateAccountCredentialsClient{ClientStream: stream}
	return x, nil
}
...
func (c *credentialzClient) RotateHostParameters(ctx context.Context, opts ...grpc.CallOption) (Credentialz_RotateHostParametersClient, error) {
	...
	x := &credentialzRotateHostParametersClient{ClientStream: stream}
	return x, nil
}
...
// UnimplementedCredentialzServer should be embedded to have forward compatible implementations.
...
func _Credentialz_RotateAccountCredentials_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CredentialzServer).RotateAccountCredentials(&credentialzRotateAccountCredentialsServer{ServerStream: stream})
}
...
func _Credentialz_RotateHostParameters_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CredentialzServer).RotateHostParameters(&credentialzRotateHostParametersServer{ServerStream: stream})
}
