...
func (c *certzClient) Rotate(ctx context.Context, opts ...grpc.CallOption) (Certz_RotateClient, error) {
	...
	x := &certzRotateClient{ClientStream: stream}
	return x, nil
}
...
// UnimplementedCertzServer should be embedded to have forward compatible implementations.
...
func _Certz_Rotate_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CertzServer).Rotate(&certzRotateServer{ServerStream: stream})
}
