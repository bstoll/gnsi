...
func (c *pathzClient) Rotate(ctx context.Context, opts ...grpc.CallOption) (Pathz_RotateClient, error) {
	...
	x := &pathzRotateClient{ClientStream: stream}
	return x, nil
}
...
// UnimplementedPathzServer should be embedded to have forward compatible implementations.
...
func _Pathz_Rotate_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(PathzServer).Rotate(&pathzRotateServer{ServerStream: stream})
}
